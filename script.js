...
const movementsDescription = movements.map(
  (mov, i) =>
    `Moement ${i + 1}: You ${mov > 0 ? 'deposited' : 'withdrew'} ${Math.abs(
      mov
    )}`
);
...
//----------------------------------------- BANKIST ---------------------------------------
// Elements
const labelWelcome = document.querySelector('.bankist__welcome');
...
//sum all of this movements in all of this accounts
...
//Array.from
const d = Array.from({ length: 7 }, (cur, i) => i + 1);
console.log(d);
